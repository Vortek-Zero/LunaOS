...
_CODE_PATTERNS = re.compile(
    ...
    r"complexidade|performan[cç]e|otimiza)",
    re.IGNORECASE,
)
...
_ARCH_PATTERNS = re.compile(
    ...
    r"refatora[çc][ãa]o profunda|m[oó]dulo|componentiza[çc][ãa]o)",
    re.IGNORECASE,
)
...
_WEB_SEARCH = re.compile(
    ...
    r"not[íi]cia|cota[çc][ãa]o|clima|pre[çc]o)",
    re.IGNORECASE,
)
