...
class OutputParser:
    ...
    def validate_response(self, response_dict: dict) -> tuple[bool, str | None]:
        """
    ...
    def should_retry_search(self, response_dict: dict) -> bool:
        ...
        return any(pattern in resposta if isinstance(pattern, str) else pattern for pattern in retry_patterns)
    ...
    def improve_specificity(self, response_dict: dict, context: str = "") -> dict:
        ...
        if context and len(context) > 50:
            ...
            generic_patterns = ["eu diria que", "em geral", "tipicamente", "provavelmente"]
